(function(window, undefined) {
	...
	jQuery.prototype.find = function(selector) {
		return this.mapOne(function (el) {
			return jQuery(el.querySelectorAll(selector)[0]);
		});
	}
	...
	jQuery.prototype.width = function(val) {
		if (typeof val !== "undefined") {
			return this.forEach(function (el) {
				el.setAttribute("style","display:block;width:"+val+"px");
	...
	jQuery.prototype.move = function(final_x, final_y, interval) {
		return this.forEach(function (el) {
			function moveEle(final_x, final_y, interval) {
				if (el.movement) {
					clearTimeout(el.movement);
				}
				if (!el.style.left) {
					el.style.left = "0px";
				}
			...
			var repeat = "moveEle("+final_x+","+final_y+","+interval+")";
			el.movement = setTimeout(repeat,interval);
		});
	}
	jQuery.prototype.overflown = function() {
		return this.mapOne(function (el) {
