...
/*
	...
	TweenMax.from( $('#animation-header-tagline'), 1+Math.random(), {css:{ left:'-300px', opacity:'0'}, delay:0.5, ease:Expo.easeOut});
	TweenMax.from( $('#animation-header-the-chevy'), 0.5, {css:{ left:'-300px', opacity:'0'}, delay:1, ease:Circ.easeOut});
	TweenMax.from( $('#animation-header-corvette'), 1.25, {css:{ left:'-300px', opacity:'0'}, delay:1.5, ease:Circ.easeOut});
	TweenMax.from( $('#animation-header-car'), .5, {css:{ right:'-300px', opacity:'0'}, delay:2, ease:Circ.easeIn});
